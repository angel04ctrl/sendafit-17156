...
-- Only webhooks via service role can update (this policy is bypassed by service role)
...
-- Service role can still delete if needed (bypasses RLS)
...
'Contains sensitive payment data (Stripe/PayPal IDs). Access strictly restricted by RLS policies. 
